...
- `editorial.css`：参考仓库英文索引页重构的编辑式网格与页面分布。
...
- 沿用仓库英文索引页的编辑系统：3px Dify Blue 顶线、52px 白色顶栏、44/56 主分栏、细分隔线、单色正文和蓝色索引。
...
版式参考：[Dify X English index](../index_en.html)。讲座复用其视觉语法，但不复制首页的内容结构。
