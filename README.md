...
## Repo map
- `index.html`: single bilingual home page (EN / 中文) — JS i18n with system-language detection, fixed two-pane layout (hero left, FLIP-filtered deck list scrolling right), scroll-reveal animations, and the original ink/paper/blue palette. Decks live in the `DECKS` array in this file.
